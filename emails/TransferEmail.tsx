...
// This is now a simple React component for preview purposes only
// The actual email sending uses HTML templates in lib/email.ts
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ paddingBottom: '20px', textAlign: 'left' }}>
          <img
            src="public/images/msutexas-logo.png"
            width="120"
            height="48"
        ...
        <div style={{ textAlign: 'center', padding: '0' }}>
          ...
          <div style={{
            margin: '32px 0',
            height: '2px',
            background: 'linear-gradient(to right, rgba(255,255,255,0), #8a3040, rgba(255,255,255,0))',
          }} />
...
export async function sendEmail(options: EmailOptions): Promise<EmailResponse> {
  ...
  if (!EMAIL_CONFIG.email || !EMAIL_CONFIG.pass) {
    ...
    return {
      success: false,
      message: 'Email credentials not configured. Set EMAIL and PASS environment variables.',
    };
  }
...
export async function sendTransferEmail({
  ...
  const formUrl = transferFormUrl || `${EMAIL_CONFIG.baseUri}/transfer-advising-full-form`;
...
/**
 * HTML template for transfer email
 */
